...
var Home = function (_Component) {
  ...
  (0, _createClass3.default)(Home, [{
    ...
    value: function children() {
      var banArrs = (this.state.baseData)?this.state.baseData.index_lb:[];
      var naviArrs = (this.state.baseData)?this.state.baseData.button:[];
      var listArrs = (this.state.baseData)?this.state.baseData.templates.slice(4):[];
